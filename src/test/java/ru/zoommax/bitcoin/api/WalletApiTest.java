...
import ru.zoommax.bitcoin.model.AccountType;
import ru.zoommax.bitcoin.model.WalletInfo;
import ru.zoommax.bitcoin.model.WalletTransaction;
...
public class WalletApiTest {
    ...
    private WalletApi api = new WalletApi("user", "pwd", "http://127.0.0.1:18332/");
    private RawTransactionsApi txapi = new RawTransactionsApi("user", "pwd", "http://127.0.0.1:18332/");
